...
namespace Entidades
{
    public class Juego
    {
        ...
        private Desarrolladora CodigoDes;
        private Distribuidora CodigoDis;
        ...
        public string GetCodigoDes() { return this.GetCodigoDes(); }
        public string GetCodigoDis() { return this.GetCodigoDis(); }
