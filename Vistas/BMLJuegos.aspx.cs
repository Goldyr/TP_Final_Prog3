...
namespace WebApplication1
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        */
        ...
        {
            switch(Convert.ToInt32(rbl_Tipolistado.SelectedValue))
            {
                case 0:
                ...
                case 1:
                    ...
                    break;
                case 2:
                    grdBMLJuegos.DataSource = ns_juego.NJ_ListarJuegos_Nombre(tb_Busqueda.Text);
                    grdBMLJuegos.DataBind();
                    break;
            }
        ...
        protected void grdBMLJuegos_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            rbl_Tipolistado.SelectedValue = "0";
